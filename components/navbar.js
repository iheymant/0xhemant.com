...
function setupMobileMenu() {
  ...
  // FIX 1: declare siteHeader here — it was only declared inside
  // setupDropdownMenu before, causing a ReferenceError at runtime.
  ...
  /* =========================
     BACK BUTTONS
     FIX 3: instead of hardcoding 'show-builds', dynamically
     remove whichever show-* class is currently active.
  ========================= */
  ...
  backButtons.forEach(button => {
    ...
    button.addEventListener('click', () => {
      ...
      // Find and remove any active show-* class generically
